...
<TestLog item={item} slug={frontmatter.slug}>
    ...
    <Fragment slot="results">
        All clothing on the subject spontaneously disintegrate, leaving [Cpt. Ozzwitch](staff/ozzwitch) almost completely naked.
        ~~This also had a minor memetic effect on all observers with a history of male attraction, eliciting feelings of~~
        Disregard the previous, [Cpt. Ozzwitch](staff/ozzwitch) is just that attractive.
    </Fragment>
