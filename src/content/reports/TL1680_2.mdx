...
<TestLog item={item} slug={frontmatter.slug}>
    ...
    <Fragment slot="goal">Cross lake without OCP-1680 interaction.</Fragment>

    <Fragment slot="procedure">
        Instruct subject to reach a structure on the other side of the <Redacted>[REDACTED]</Redacted> lake without interacting with OCP-1680.
    </Fragment>

    <Fragment slot="results">
        Following subject agitatation and protest regarding the futility of swimming that far,
        the subject was provided Federation grade scuba gear outfitted with automatic adrenaline pumps to prevent exhaustion.
