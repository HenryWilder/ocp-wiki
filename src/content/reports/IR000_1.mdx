...
<IncidentReport item={item} slug={frontmatter.slug}>
    ...
    <Fragment slot="reportedBy"><Redacted>xxxxxxxxxx</Redacted></Fragment>
    <Fragment slot="object">000</Fragment>

    <Fragment slot="description">We have absolutely no idea what happened.</Fragment>
    ...
    <Fragment slot="followup">A janitor put a wet floor sign by the corner of the room.</Fragment>
</IncidentReport>