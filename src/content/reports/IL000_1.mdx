...
import { IInterviewLog, IInterviewMember } from "../../scripts";
...
<InterviewLog item={item} alwaysOpenOnSlug={frontmatter.slug}>
...
<Comment>
    ...
    <AnchorTooltip href="#interview-log-000-1">@jrRsr<Redacted>Xxxxxxxx</Redacted></AnchorTooltip>, care to explain?
